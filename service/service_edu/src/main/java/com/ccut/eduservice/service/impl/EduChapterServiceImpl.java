...
import com.ccut.eduservice.entity.chapter.VideoVo;
import com.ccut.eduservice.mapper.EduChapterMapper;
import com.ccut.eduservice.service.EduChapterService;
...
public class EduChapterServiceImpl extends ServiceImpl<EduChapterMapper, EduChapter> implements EduChapterService {
    ...
    public boolean deleteChapter(String chapterId) {
        ...
        if(count >0) {//查询出小节，不进行删除
            throw new JiangDiException(20001,"不能删除");
        } else { //不能查询数据，进行删除
            //删除章节
